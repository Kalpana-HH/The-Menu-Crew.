  ...
  return (
    <div className="fixed inset-0 bg-neutral-900/60 backdrop-blur-xs flex items-center justify-center z-50 p-4 sm:p-6 font-sans overflow-y-auto">
      <motion.div
        ...
        className="bg-white border border-[#EBE7DF] rounded-3xl w-full max-w-md shadow-2xl flex flex-col max-h-[90vh] my-auto overflow-hidden"
      ...
      >
        <div className="p-6 sm:p-8 space-y-5 overflow-y-auto">
          ...
          {/* Settings Note */}
          <p className="text-[10px] text-neutral-400 text-center flex items-center justify-center gap-1 pt-1">
